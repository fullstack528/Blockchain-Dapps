...
pub const RET_VAL_U256: &str = "RET_VAL_U256";
...
pub const ENTRY_POINT_NAME_CLAIMABLE_AMOUNT: &str = "claimable_amount";
pub const ENTRY_POINT_NAME_TOTAL_LOCK_AMOUNT: &str = "total_lock_amount";
pub const ENTRY_POINT_NAME_VESTED_AMOUNT: &str = "vested_amount";
pub const ENTRY_POINT_NAME_AMOUNT_PER_HOURLY: &str = "get_amount_per_hourly";
